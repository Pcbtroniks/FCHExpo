<section class="md:grid md:grid-cols-2 ">
  ...
  <div class="p-8 flex flex-col md:gap-8 gap-2">
    <div class="md:p-16 w-full" data-aos="fade-down">
              ...
              <h1 class="font-bold text-3xl md:text-5xl text-center text-white">Luis Macías</h1>
    </div>

    <div data-aos="fade-right">
      <div class="container md:h-96 w-full h-full">
          <div class="contentContainer w-full h-full  overflow-hidden relative">
             <img class="w-full h-full  object-cover "  src="{{asset('assets/img/artist/LUIS-1.jpg')}}">
             <img class="hidden"  src="{{asset('assets/img/artist/LUIS-2.jpg')}}">
             <img class="hidden"  src="{{asset('assets/img/artist/LUIS-3.jpg')}}">
         </div>
     </div>
    </div>
    </div>
     ...
     <div class="p-6 md:p-20 flex flex-col h-auto">
                   <div class=" md:h-96 w-full h-full overflow-hidden relative" data-aos="fade-left">
             <img class="w-full h-full object-cover"  src="{{asset('assets/img/artist/LUIS2.png')}}">
